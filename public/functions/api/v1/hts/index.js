...
export async function onRequestGet(context) {
  try {
    ...
    const DATA = [
      ...
      { code: '8518.30.0000', desc: 'Loudspeakers, without enclosure', duty: 'Free', adcvd: 'none', keywords: ['loudspeaker','speaker','soundbar','pa speaker','woofer','bluetooth speaker'] },
      ...
      { code: '9013.80.0010', desc: 'LED display panels', duty: 'Free', adcvd: 'none', keywords: ['led display','led panel','lcd panel','monitor','screen','digital signage','led'] },
