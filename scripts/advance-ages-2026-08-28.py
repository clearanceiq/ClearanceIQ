#!/usr/bin/env python3
"""Advance ClearanceIQ task ages by 1 day for 2026-08-28 brief."""
import re, os

TODAY = "2026-08-28"

FILES = {
    r"C:\Users\Najmi\Documents\Tycoon\site\ops\daily-tasks.md": ("2026-08-27", 1),
    r"C:\Users\Najmi\Documents\Tycoon\site\public\ops\daily-tasks.md": ("2026-08-27", 1),
    r"C:\Users\Najmi\Documents\Tycoon\site\TODO.md": ("2026-08-27", 1),
    r"C:\Users\Najmi\Documents\Tycoon\site\public\TODO.md": ("2026-08-27", 1),
    r"C:\Users\Najmi\Documents\Tycoon\site\docs\TASKS.md": ("2026-08-25", 3),
    r"C:\Users\Najmi\Documents\Tycoon\site\public\docs\TASKS.md": ("2026-08-25", 3),
}
...
def advance_file(path, old_stamp_date, days):
    ...
    # Replace entire stamp line for # Last briefing
    new_text = re.sub(
        r'^# Last briefing:.*$',
